...
import { buildStudentRoomDetailSelect, roomHeaderSelect, teacherRoomListSelect } from './roomProjections';
...
describe('ルームレスポンス', () => {
  ...
  it('生徒向け詳細に教師専用情報を含めない', () => {
    const studentRoomDetailSelect = buildStudentRoomDetailSelect('student-1');
